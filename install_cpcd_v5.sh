...
cd $HOME/Workswith_WiSUN/cpc_daemon_stash/ || exit
...
CPC_VERSION=$(grep 'set(CPC_PROTOCOL_VERSION' $HOME/Workswith_WiSUN/cpc_daemon_stash/CMakeLists.txt | awk -F\" '{print $2}')
